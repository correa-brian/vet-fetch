...
class VFAccountViewController: VFViewController, UIScrollViewDelegate {
    ...
    override func loadView(){
        ...
        for btnTitle in buttonTitles {
            ...
            btn.tag = Int(y)
            btn.addTarget(self, action: #selector(VFAccountViewController.btnAction(_:)), forControlEvents: .TouchUpInside)
    ...
    func btnAction(sender: UIButton){
        ...
        if(buttonTitle == "join with email"){
            let registerVc = VFLoginViewController()
